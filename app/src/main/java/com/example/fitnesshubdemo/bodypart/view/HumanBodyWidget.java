...
import com.example.fitnesshubdemo.bodypart.BodyFragmentOriginal;
...
//    private FragmentManager.OnBackStackChangedListener onBackStackChangedListener;
    ...
    private boolean performFragmentFlipAnimation() {
        ...
        activity.getFragmentManager()
                .beginTransaction()
                .setCustomAnimations(
                        R.animator.body_flip_right_in, R.animator.body_flip_right_out,
                        R.animator.body_flip_left_in, R.animator.body_flip_left_out)
    ...
    public static class BodyFrontFragment extends BodyFragmentOriginal {
    ...
    public static class BodyBackFragment extends BodyFragmentOriginal {
